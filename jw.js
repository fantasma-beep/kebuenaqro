...
self.addEventListener('fetch', (event) => {
  // Este evento se dispara cada vez que la página solicita un recurso (imágenes, scripts, etc.).
  // Para una app de streaming, no guardamos nada en caché para asegurar que el contenido sea siempre en vivo.
